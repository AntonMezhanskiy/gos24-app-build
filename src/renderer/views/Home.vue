<template>
    <div class="Home" :class="{checked}">
        <nav class="menu">
            ...
            <button type="button" data-value="Свернуть программу" @click="change(dictionary.collapseApp)" class="menu-item">
            ...
            <button type="button" data-value="Авторизоваться" @click="change(dictionary.auth)" v-if="!isAuth" class="menu-item">
            ...
            <button type="button" data-value="Центр уведомлений" @click="change(dictionary.link, 'https://gos24.kz/notification')" :data-notify-count="countNotify" class="menu-item">
            ...
            <button type="button" data-value="Задать вопрос" @click="change(dictionary.link, 'https://gos24.kz/qa/new')" class="menu-item">
            ...
            <button type="button" data-value="Открыть портал" @click="change(dictionary.link, 'https://gos24.kz')" class="menu-item">
