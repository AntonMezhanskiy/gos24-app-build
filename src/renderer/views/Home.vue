<template>
    <div class="Home" :class="{checked}">
        <nav class="menu">
            ...
            <button type="button" data-value="Свернуть программу" @click="change('collapse-app')" class="menu-item">
            ...
            <button type="button" data-value="Сменить аккаунт" @click="change('change-user')" v-if="isAuth" class="menu-item">
            ...
            <button type="button" data-value="Авторизоваться" @click="change('auth')" v-else class="menu-item">
            ...
            <button type="button" data-value="Перейти на портал" @click="change('link', 'https://gos24.kz')" class="menu-item">
            ...
            <button type="button" data-value="Центр уведомлений" @click="change('link', 'https://gos24.kz/notification')" :data-notify-count="countNotify" class="menu-item">
