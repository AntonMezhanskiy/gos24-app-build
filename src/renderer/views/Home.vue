<template>
    <div class="Home">
        <HomeSlot class="menu" v-slot="{ propData, change, isAuth, toggle }" :isMove="isMove">
            ...
            <button type="button" data-value="Свернуть программу" @click="change(propData.dictionary.collapseApp)" class="menu-item">
            ...
            <button type="button" data-value="Авторизоваться" @click="change(propData.dictionary.auth)" v-if="!isAuth" class="menu-item">
            ...
            <button type="button" data-value="Центр уведомлений"
                    @click="change(propData.dictionary.link, 'https://gos24.kz/notification')"
                    :data-notify-count="propData.countNotify"
                    class="menu-item">
            ...
            <button type="button" data-value="Задать вопрос" @click="change(propData.dictionary.link, 'https://gos24.kz/qa/new')" class="menu-item">
            ...
            <button type="button" data-value="Обратиться к куратору" @click="change(propData.dictionary.link, 'https://gos24.kz/support/new')" class="menu-item">
            ...
            <button type="button" data-value="Открыть портал" @click="change(propData.dictionary.link, 'https://gos24.kz')" class="menu-item">
