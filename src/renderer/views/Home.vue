<template>
    <div class="Home" :class="{checked}">
        <nav class="menu">
            ...
            <button type="button" data-value="Сменить аккаунт" class="menu-item">
                <svg v-if="isAuth" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.016 512">
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 478.024 478.024">
    ...
    export default {
        ...
        methods: {
            toggle () {
                ...
                const setWindowSize = status ? { width: 220, height: 500 } : {};
                this.checked = status;
